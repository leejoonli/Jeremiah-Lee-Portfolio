...
function About() {
    return (
        <div className={styles.aboutContainer}>
            ...
            <br />
            <p className={styles.aboutDesc}>After working as a camera assistant, I decided to leave the film industry and pursue an opportunity to change my future. I always had an interest in the sciences even in my earlier years, but now that interest has transformed into a fascination.  Coding has taken over the driver's seat and it's full steam ahead.</p>
            <br />
